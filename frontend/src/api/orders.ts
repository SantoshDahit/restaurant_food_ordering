...
import type { OrdersResponse, OrderCreateRequest, OrderStatusUpdateRequest, PageResponse, OrderStatus, OrderType } from '@/types'

export const ordersApi = {
  search: (params: { restaurantCode?: string; status?: OrderStatus; orderType?: OrderType; tableCode?: string }) =>
